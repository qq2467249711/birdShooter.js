"use strict";
var websocketio = require("websocket.io");
var express = require('express');
var app = express();
var bodyparser = require('body-parser');
var mysql = require("mysql");
var connection = mysql.createConnection(process.env.OPENSHIFT_MYSQL_DB_URL+"birdshooter");
var websocketServer = new websocketio.Server;
connection.connect(function(){
    connection.query("drop table Users;create table if not exists Users (Username char(20),Password char(20), birdsKilled int, bulletsShot int, eggs int, reloadTime int, weaponCooldownT int, weaponSpeed int, bulletSpeed int, level int);",function(){
