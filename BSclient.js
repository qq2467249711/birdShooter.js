...
var birdWidth = 105;
var birdWidthPlusOne = birdWidth+1;
var birdHeight = 95;
var birdHeightMinusOne = birdHeight-1;
var weaponWidth = 52;
var weaponHeight = 70;
var bulletWidth = 6;
var bulletHeight = 39;
...
function moveImage(fromX,fromY,toX,toY,item,itemWidth,itemHeight){
	context.fillStyle = 'white';
	context.fillRect(fromX, fromY, itemWidth, itemHeight);
	context.drawImage(weapon,toX,toY);
}
function clrScreen(){
...
function loadl(){
	...
	if(window.localStorage.birdKilled)
...
function stars(i,strs){
	if(i >= player.password.length)
		return stars(--i,strs);else{
		strs+="*";
		return strs;}
}
function pp(){
